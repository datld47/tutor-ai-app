...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.custom_editor_view = QWebEngineView() # Editor cho cột trái
        self.custom_editor_initialized = False # Cờ quản lý
    ...
    def build_left_panel(self):
        ...
        # --- THAY ĐỔI TẠI ĐÂY ---
        # 1. Tải file custom_editor.html vào QWebEngineView mới
    ...
    def on_start_custom_exercise(self):
        ...
        def process_description(description):
            # Dọn dẹp các thẻ HTML không cần thiết và khoảng trắng
            ...
            self.current_exercise = {
                "id": "custom_exercise",
                "title": "Bài tập tự do",
                "description": description, # Lưu dưới dạng HTML
